...
//                                .requestMatchers("/enquiries/**").permitAll()
                                ...
                                .requestMatchers("/deleteStudent/{id}/**").hasAuthority("ADMIN")
                                .requestMatchers("/updateStudent/{id}/**").hasAuthority("ADMIN")
                                .requestMatchers("/status/{status}/**").hasAnyAuthority("ADMIN","USER")
                                .requestMatchers("/status/{id}/**").hasAuthority("ADMIN")
                                .requestMatchers("/updatedeleteStudent/{id}/**").hasAuthority("ADMIN")
                                .anyRequest()
                                .authenticated()
